...
def index(request):
	...
	context = {
		...
		'javascript_hot':algorithms_hot,
		'algorithms':algorithms_new,
		'algorithms':algorithms_hot,
		'machinelearning_new':machinelearning_new,
		'machinelenrning_hot':machinelearning_hot,
		'operatingsystem':operatingsystem_new,
		'operatingsystem':operatingsystem_hot,
